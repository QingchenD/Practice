...
public class AidlTestActivity extends Activity {
    ...
    private static String TAG = "AidlTestActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Log.i(TAG, " start second activity");
                Intent intent1 = new Intent(getApplicationContext(), AidlTestActivitySecond.class);
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(getApplicationContext(), MyAidlService.class);
                isConnectedToService = bindService(intent1, mConnection, BIND_AUTO_CREATE);
            }
        });
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Log.i(TAG, " stopServiceImmediately threadId:" + Thread.currentThread().getId());
                //  Intent intent1 = new Intent(getApplicationContext(), MyAidlService.class);
                try {
                    if (mAidl != null) {
                        mAidl.stopServiceImmediately();
                    }
